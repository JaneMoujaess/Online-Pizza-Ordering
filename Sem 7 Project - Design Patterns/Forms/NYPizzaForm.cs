...
{
    public partial class NYPizzaForm : Form
    {
        CartData cartData;
        public NYPizzaForm(CartData cartData)
        {
            InitializeComponent();
        ...
        {
            NYStylePizzaFactory nYStylePizzaFactory = new NYStylePizzaFactory();
            Pizza pizza;

            if (rdbtnPepperoni.Checked == true)
                pizza = nYStylePizzaFactory.createPizza("pepperoni");
            else if (rdbtnBBQChicken.Checked == true)
                pizza = nYStylePizzaFactory.createPizza("chicken");
            else if (rdbtnVeggie.Checked == true)
                pizza = nYStylePizzaFactory.createPizza("veggie");
            else
            {
